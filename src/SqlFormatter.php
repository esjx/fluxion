...
class SqlFormatter
{
    ...
    protected static $reserved = array(
        ...
        'VIEW', 'WHEN', 'WITH', 'WORK', 'WRITE', 'YEAR_MONTH', 'INSERTED', 'TOP'
    );
     ...
     */
    public static function format($string, $highlight=true, $pre = true)
    {
        ...
        foreach ($tokens as $i=>$token) {
            ...
            if ($token[self::TOKEN_VALUE] === '(') {
                ...
                if ($inline_parentheses && $length > 60) {
     ...
     */
    public static function highlight($string, $pre = true)
    {
     ...
     * @return String The quoted string
     */
    private static function output($string, $pre = true)
    {
        if (self::is_cli() || !$pre) {
            return $string."\n";
        } else {
