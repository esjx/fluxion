            ...
            if($this->content[$position] == " " && !$coloredTagName){
                ...
                for(;$position < strlen($this->content) && $this->content[$position] != ">" ;$position++){
                    if($this->content[$position] != "="){
                        ...
                        $value="";
                        $buffer .= "<span class='text-orange'>".$attribute."</span>=";
                        ...
                        $buffer .= "<span class='text-green'>".$value."</span>";
                        break;
                    }

                }
                if($attribute != ""){$buffer.="<span class='text-orange'>".$attribute."</span>";}
            }
